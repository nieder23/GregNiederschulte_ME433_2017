...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            int rowGap = 10; // How many rows to analyze along the Y axis
            for(int startY = 100; startY < bmp.getHeight(); startY += rowGap ) {// which row in the bitmap to analyze to read
